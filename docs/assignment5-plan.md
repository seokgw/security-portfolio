...
과제 4(`t04-real-information-board`)의 정보판에 **데이터 상태(`fresh` / `stale` / `error`)와 마지막 정상값을 사용자가 명확하게 구분할 수 있는 상태 표시 영역 개선** 1개만 구현한다.
...
- 대상 프로젝트 경로: `t04-real-information-board/`
